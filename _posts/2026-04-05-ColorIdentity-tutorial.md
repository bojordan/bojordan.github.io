...
__Update:__ I've added the "harmony" mode where it picks colors influenced by your currently active theme. I've also pushed the first build to the [VS Code extensions marketplace](https://marketplace.visualstudio.com/items?itemName=bojordan.color-identity), so go give it a try.

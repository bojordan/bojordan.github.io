...
More fun than the game itself: I generated a [12-lesson tutorial](/projects/minecraft2d/tutorial/) that walks through building it from scratch, aimed at a fifth-grade reading level. Each lesson is a self-contained web page with live interactive demos embedded right in the page.
